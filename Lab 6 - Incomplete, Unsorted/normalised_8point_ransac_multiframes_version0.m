% function [fundamental_matrices, inliers_matched_features_combined] = normalised_8point_ransac_multiframes(matched_features_combined, matches_cells, N, P, no_points, threshold)
    % # INPUT PARAMETERS
    ...
    for k = 1:length(matches_cells)
        matches = matches_cells{k}; 
        feat1 = matched_features_combined{1,k}{1,1};
        feat2 = matched_features_combined{2,k}{1,1};
        ...
        while iter < N
            ...
            inliers_matched_features_combined{1,k}{1,1} = feat1_bestglobal;
            inliers_matched_features_combined{2,k}{1,1} = feat2_bestglobal;
            fundamental_matrices{1,k} = F_best_global;
    end
